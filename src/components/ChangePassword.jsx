...
export default function ChangePassword() {
  ...
  return (
    <div style={{
      ...
      <div style={{
        width: "100%", maxWidth: 420, animation: "slideIn 0.4s ease-out"
      }}>
        <div style={{ marginBottom: 30, textAlign: "center" }}>
          <h2 style={{ fontSize: 28, fontWeight: 800, color: "var(--text-primary)", margin: 0 }}>Change Password</h2>
          <p style={{ fontSize: 13, color: "var(--text-secondary)", marginTop: 8 }}>Enter your current and new password</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 18 }}>
          <div>
            <label style={{ display: "block", fontSize: 12, fontWeight: 700, color: "var(--text-muted)", marginBottom: 6, textTransform: "uppercase", letterSpacing: 0.5 }}>Current Password</label>
            <input
          ...
          <div>
            <label style={{ display: "block", fontSize: 12, fontWeight: 700, color: "var(--text-muted)", marginBottom: 6, textTransform: "uppercase", letterSpacing: 0.5 }}>Confirm New Password</label>
            <input
